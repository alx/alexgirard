...
Pour éveiller l'intérêt des utilisateurs, et les pousser à participer à l'essor de la base de donnée, le concept peut être rendu interactif. Il peut être simple d'utiliser twitter pour permettre l'ajout de torrent, binema ne sera alors qu'un robot qui reçoit des commandes et les affiche sur une page web.