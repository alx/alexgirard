...
After moving to "Jekyll and Git blogging":http://alexgirard.com/2008/11/18/using-git-to-blog.html yesterday, I fougt a bit to retrieve my old post from "my current Wordpress blog":http://blog.alexgirard.com inside this new blog.
