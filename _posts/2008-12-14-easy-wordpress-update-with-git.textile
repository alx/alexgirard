...
* Copy the files from the new Wordpress to your local git clone: _cp -r ~/Download/wordpress/* ~/my_blog_clone/_
...
* Move to your blog folder in your server, it should already be a git clone: _cd my_blog_clone_
