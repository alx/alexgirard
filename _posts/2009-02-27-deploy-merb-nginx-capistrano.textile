...
I hope it'll help other merb dev to fill the documentation hole about this process, feel free to complete or debug it in the comments.

!/images/merb_deploy.png!

Let's suppose you all know how to use "Capistrano":http://www.capify.org/, and that your project is already deployed using it (it's the easiest part to get), you now want "Nginx":http://wiki.codemongers.com/ to serve your merb app.

h2. Nginx

First, you need to configure nginx, to pass your request to your merb app. In _/etc/nginx/conf.d/merb.conf_:
...
We can merge this 2 files in the same configuration file, it's just working this way today.
